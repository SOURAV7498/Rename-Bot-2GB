...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        [InlineKeyboardButton('🔊 Updates', url='https://t.me/Movieroll_bot'),
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("⚡ Mᴏᴠɪᴇ's Dᴏᴡɴʟᴏᴀᴅɪɴɢ Cʜᴀɴɴᴇʟ", url="https://t.me/+Uy4hZPZA-Q0yMjI1")],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🤖 More Bots", url="https://t.me/Movieroll_bot")],
                [InlineKeyboardButton("🔒 Close", callback_data = "close"),
                InlineKeyboardButton("◀️ Back", callback_data = "start")]
            ])            
        )
...
async def donate(client, message):
	...
	keybord = InlineKeyboardMarkup([
        			[InlineKeyboardButton("🦋 Admin",url = "https://t.me/Movieroll_Owner"), 
